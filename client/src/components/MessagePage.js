...
const MessagePage = () => {
  ...
  return (
    <div style={{ backgroundImage : `url(${backgroundImage})`}} className='bg-no-repeat bg-cover -z-50'>
              ...
              <div className='relative '>
                  ...
                  {/**video and image */}
                  {
                    openImageVideoUpload && (
                      <div className='bg-white shadow rounded absolute bottom-14 w-36 p-2 z-40'>
                      <form>
